    ...
    const data = [
        {
            ...
            description: 'HTML, CSS, JavaScript React-Js, Next-Js, Sql, Java',
        },
        {
            name: 'Education',
            icon1: './assets/edu-icon.png',
            icon2: './assets/edu-icon-dark.png',
            description: 'Masters Computer Application from PSIT Kanpur',
        },
        {
            name: 'Projects',
            icon1: './assets/project-icon.png',
            icon2: './assets/project-icon-dark.png',
            description: 'Built more than 5 projects In Web Developmet',
        },
    ];
    return (
